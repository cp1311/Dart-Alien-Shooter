...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGLRenderingContext"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.math", "dart:math", , P, {
  ...
  _RectangleBase: {
    ...
    get$hashCode: function(_) {
      var t1, hash;
      t1 = this.top;
      t1 = P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(0, this.get$left() & 0x1FFFFFFF), t1 & 0x1FFFFFFF), this.left + this.width & 0x1FFFFFFF), t1 + this.height & 0x1FFFFFFF);
      hash = 536870911 & t1 + ((67108863 & t1) << 3 >>> 0);
      hash ^= hash >>> 11;
      return 536870911 & hash + ((16383 & hash) << 15 >>> 0);
    }
  },
...
["gameengine", "shootergame/gameengine.dart", , T, {
  "^": "",
  GameCore: {
    "^": "Object;stage,player,width,height",
    drawBackground$0: function() {
      var bgImg, t1, t2, t3, maxX, maxY, m, n, t4, t5;
      bgImg = W.ImageElement_ImageElement(null, "shootergame/images/metal_floor.png", null);
      t1 = J.getInterceptor$x(bgImg);
      if (t1.get$width(bgImg) !== 0 && t1.get$height(bgImg) !== 0) {
        t2 = this.width;
        t3 = t1.get$width(bgImg);
        if (typeof t3 !== "number")
          return H.iae(t3);
        maxX = C.JSNumber_methods.toInt$0(Math.ceil(t2 / t3));
        t3 = this.height;
        t2 = t1.get$height(bgImg);
        if (typeof t2 !== "number")
          return H.iae(t2);
        maxY = C.JSNumber_methods.toInt$0(Math.ceil(t3 / t2));
        for (t2 = this.stage, t3 = J.getInterceptor$x(t2), m = 0; m < maxX; ++m)
          for (n = 0; n < maxY; ++n) {
            t4 = t1.get$width(bgImg);
            if (typeof t4 !== "number")
              return H.iae(t4);
            t5 = t1.get$height(bgImg);
            if (typeof t5 !== "number")
              return H.iae(t5);
            t3.drawImage$3(t2, bgImg, m * t4, n * t5);
          }
      }
    },
    GameCore$3: function(stage, width, height) {
      var t1;
      this.width = width;
      this.height = height;
      t1 = this.stage;
      J.set$fillStyle$x(t1, "#000000");
      t1.fillRect(0, 0, this.width, this.height);
    }
  }
}],
["gameentities", "shootergame/entities/gameentities.dart", , O, {
  "^": "",
  PlayerChar: {
    "^": "Object;img,x,y,rec,upImg,upRightImg,upLeftImg,downImg,downLeftImg,downRightImg,leftImg,rightImg,moveX,moveY,moveUp,moveDown,moveLeft,moveRight,shoot,health,lives,score,mouseDelta",
    PlayerChar$2: function(x, y) {
      var t1 = this.upImg;
      this.img = t1;
      this.rec = P.Rectangle$(this.x, this.y, J.get$width$x(t1), J.get$height$x(this.img), null);
    }
  }
}],
...
["", "projekt_shooter.dart", , A, {
  "^": "",
  main: [function() {
    var t1 = J.get$onMouseDown$x(document.querySelector("#startbutton"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.startGame$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  startGame: [function($event) {
    var target = J.get$target$x($event);
    if (!$.gameRunning) {
      $.gameRunning = true;
      J.get$classes$x(target).add$1(0, "disabled");
      A.initGame();
    }
  }, "call$1", "startGame$closure", 2, 0, 6],
  initGame: function() {
    var canvas, t1, t2, stage;
    canvas = document.querySelector("#game");
    t1 = J.getInterceptor$x(canvas);
    t1.get$classes(canvas).remove$1(0, "hidden");
    t2 = t1.get$onClick(canvas);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new A.initGame_closure(canvas)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    stage = t1.getContext$1(canvas, "2d");
    t1 = H.setRuntimeTypeInfo(new W._EventStream(document, "webkitpointerlockchange", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.pointerLockChange$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = new O.PlayerChar(null, 512, 700, null, W.ImageElement_ImageElement(null, "shootergame/images/player_up.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_up_right.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_up_left.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_down.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_down_left.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_down_right.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_left.png", null), W.ImageElement_ImageElement(null, "shootergame/images/player_right.png", null), 0, 0, false, false, false, false, false, 100, 3, 0, 0);
    t1.PlayerChar$2(512, 700);
    t1 = new T.GameCore(stage, t1, null, null);
    t1.GameCore$3(stage, 1024, 768);
    $.gCore = t1;
    P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 8, 0, 0), A.gameTick$closure());
    C.Window_methods.get$animationFrame(window).then$1(A.drawFrame$closure());
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.initGame_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.initGame_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(document, "mousemove", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.mouseMove$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  mouseMove: [function($event) {
    if (!$.mouselocked)
      return;
  }, "call$1", "mouseMove$closure", 2, 0, 6],
  pointerLockChange: [function(e) {
    ...
    if (!t2)
      $.gCore.toString;
  }, "call$1", "pointerLockChange$closure", 2, 0, 7],
  gameTick: [function(clock) {
    ...
    if (t4 && !t5)
      if (t3 && !t2)
        ...
        t1.img = t1.upRightImg;
      else
        t1.img = t1.upImg;
    else if (t5 && !t4)
      if (t3 && !t2)
        t1.img = t1.downLeftImg;
      else if (t2 && !t3)
        t1.img = t1.downRightImg;
      else
        t1.img = t1.downImg;
    else if (t3 && !t2)
      t1.img = t1.leftImg;
    ...
    t1.rec = P.Rectangle$(t1.x, t2, J.get$width$x(t1.img), J.get$height$x(t1.img), null);
  }, "call$1", "gameTick$closure", 2, 0, 8],
  drawFrame: [function(d) {
    var t1, t2;
    t1 = $.gCore;
    if (t1 != null) {
      t2 = t1.stage;
      J.set$fillStyle$x(t2, "#000000");
      t2.fillRect(0, 0, t1.width, t1.height);
      t1.drawBackground$0();
      t1 = t1.player;
      t2.drawImage(t1.img, t1.x, t1.y);
    }
    C.Window_methods.get$animationFrame(window).then$1(A.drawFrame$closure());
  }, "call$1", "drawFrame$closure", 2, 0, 9],
  initGame_closure: {
    "^": "Closure:24;canvas_0",
    call$1: function(e) {
      this.canvas_0.requestPointerLock();
    },
    $isFunction: true
  },
  initGame_closure0: {
...
//# sourceMappingURL=projekt_shooter.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function GameCore(stage, player, width, height) {
    this.stage = stage;
    this.player = player;
    this.width = width;
    this.height = height;
  }
  GameCore.builtin$cls = "GameCore";
  if (!"name" in GameCore)
    GameCore.name = "GameCore";
  $desc = $collectedClasses.GameCore;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameCore.prototype = $desc;
  function PlayerChar(img, x, y, rec, upImg, upRightImg, upLeftImg, downImg, downLeftImg, downRightImg, leftImg, rightImg, moveX, moveY, moveUp, moveDown, moveLeft, moveRight, shoot, health, lives, score, mouseDelta) {
    this.img = img;
    this.x = x;
    this.y = y;
    this.rec = rec;
    this.upImg = upImg;
    this.upRightImg = upRightImg;
    this.upLeftImg = upLeftImg;
    this.downImg = downImg;
    this.downLeftImg = downLeftImg;
    this.downRightImg = downRightImg;
  ...
  PlayerChar.builtin$cls = "PlayerChar";
  if (!"name" in PlayerChar)
    PlayerChar.name = "PlayerChar";
  $desc = $collectedClasses.PlayerChar;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayerChar.prototype = $desc;
